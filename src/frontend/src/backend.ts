...
import type { Response as _Response, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async fetchAllResponses(): Promise<Array<[Principal, Response]>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAllResponses();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchAllResponsesAsArray(): Promise<Array<Response>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAllResponsesAsArray();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchLatestResponse(): Promise<Response | null> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchLatestResponse();
    ...
    async fetchLatestResponseForPrincipal(arg0: Principal): Promise<Response | null> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchLatestResponseForPrincipal(arg0);
                return from_candid_opt_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitResponse(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Response]): Response | null {
